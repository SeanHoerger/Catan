...
public class Tile {
	...
	/**
	 * Location of the tile on the board stores the location object for the tile
	 */
	private Location location;

	/**
	 * Int representing which resource the tile gives when rolled 0 == wood; 1 ==
	 * brick; 2 == wheat; 3 == sheep; 4 == ore, 5 == desert
	 */
	...
	/**
	 * Getters access basic information
	 */
	...
	private Polygon getHexagon(int x, int y) {
		int[] xValues = { x, x + 3 * BoardDisplay.SCALAR, x + 3 * BoardDisplay.SCALAR, x + 0 * BoardDisplay.SCALAR,
				x - 3 * BoardDisplay.SCALAR, x - 3 * BoardDisplay.SCALAR };
		int[] yValues = { y, y + 2 * BoardDisplay.SCALAR, y + 5 * BoardDisplay.SCALAR, y + 7 * BoardDisplay.SCALAR,
				y + 5 * BoardDisplay.SCALAR, y + 2 * BoardDisplay.SCALAR };
